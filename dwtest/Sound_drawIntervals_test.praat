...
Blue
Draw intervals... 0 0.4 -1 1 n Curve 10 self>0.5
Black
Draw intervals... 0 0.4 -1 1 n Curve 10 self<=0.5
...
Draw intervals... 0 0 -1 1 n Curve 10 self>0.5
Black
Draw intervals... 0 0 -1 1 n Curve 10 self<=0.5
One mark left... 0.5 y y y
...
Select outer viewport... 0 6 6 9
Blue
Draw intervals... 0 0 -1 1 n Curve 10 self>0.5 and x mod 0.001 < 0.0005
Black
Draw intervals... 0 0 -1 1 n Curve 10 not (self>0.5 and x mod 0.001 < 0.0005)
One mark left... 0.5 y y y
