...
static int OTMulti_modifyRankings (OTMulti me, long iwinner, long iloser,
	enum kOTGrammar_decisionStrategy updateRule,
...
int OTMulti_PairDistribution_learn (OTMulti me, PairDistribution thee, double evaluationNoise, int updateRule, int direction,
