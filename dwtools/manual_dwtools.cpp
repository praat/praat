...
NORMAL (U"This problem can be solved by an iterative alternating least squares method as described by @@Borg & Groenen (1997)@. The function to use is ##solveNonnegative\\#  (a\\# \\# , y\\#  [,x\\# ], %maximumNumberOfIterations, %tolerance, %info)#")
...
NORMAL (U"My info window shows:")
NORMAL (U"0.1768707483178988 0 0.8594104308359057")
NORMAL (U"")
NORMAL (U"The same a\\# \\#  and y\\#  with extra output:")
CODE (U"result\\#  = solveNonnegative\\#  (a\\# \\# , y\\# , 100, 1e-17, 1)")
CODE (U"writeInfoLine: result\\# ")
NORMAL (U"Now my info window shows:")
NORMAL (U"Iteration: 1, error: 2.1281857767035826")
NORMAL (U"Iteration: 2, error: 0.17967621528874161")
NORMAL (U"Iteration: 3, error: 0.015391968748420859")
NORMAL (U"Iteration: 4, error: 0.011343066696597057")
NORMAL (U"Iteration: 5, error: 0.011337870560011983")
NORMAL (U"Iteration: 6, error: 0.011337868481557318")
NORMAL (U"Iteration: 7, error: 0.011337868480725925")
NORMAL (U"Iteration: 8, error: 0.011337868480725658")
NORMAL (U"Iteration: 9, error: 0.011337868480725613")
NORMAL (U"0.17687074830079372 0 0.8594104308387567")
