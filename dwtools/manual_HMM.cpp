...
INTRO (U"Calculates the cross-entropy between the selected @@HMM@ model and the @@HMM_ObservationSequence@.")
...
NORMAL (U"See also @@HMM & HMM_ObservationSequence: To TableOfReal (bigrams)...@.")
MAN_END
