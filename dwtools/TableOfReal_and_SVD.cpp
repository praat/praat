...
TableOfReal SVD_to_TableOfReal (SVD me, long from, long to)
{
	...
	} catch (MelderError) { rethrowmzero (me, ": no TableOfReal synthesized."); }
}
...
SVD TableOfReal_to_SVD (I)
{
	...
	try {
		...
		return thee.transfer();
	} catch (MelderError) { rethrowmzero (me, ": no SVD created."); }
}
...
TableOfReal SVD_extractLeftSingularVectors (I)
{
	...
	try {
		...
		return thee.transfer();
	} catch (MelderError) { rethrowmzero (me, ": left singular vector not extracted."); }
}
...
TableOfReal SVD_extractRightSingularVectors (I)
{
	...
	try {
		...
		return thee.transfer();
	} catch (MelderError) { rethrowmzero (me, ": right singular vector not extracted."); }
}
...
TableOfReal SVD_extractSingularValues (I)
{
	...
	try {
		...
		return thee.transfer();
	} catch (MelderError) { rethrowmzero (me, ": singular values not extracted."); }
}
...
GSVD TablesOfReal_to_GSVD (I, thou)
{
	...
	try {
		...
		return him.transfer();
	} catch (MelderError) { rethrowmzero ("GSVD not constructed from TablesOfReal."); }
}
