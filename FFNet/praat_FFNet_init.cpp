...
FORM3 (NEW1_PatternList_create, U"Create PatternList", nullptr) {
	...
	OK2
DO
	praat_new (PatternList_create (GET_INTEGER (U"Number of patterns"), GET_INTEGER (U"Dimension of a pattern")), GET_STRING (U"Name"));
END2 }
...
DIRECT3 (INTEGER_FFNet_getNumberOfLayers) {
	LOOP {
		iam (FFNet);
