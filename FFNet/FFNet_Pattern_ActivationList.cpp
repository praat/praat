/* FFNet_Pattern_ActivationList.cpp
 *
...
#include "Graphics.h"
#include "FFNet_Pattern_ActivationList.h"
...
static void _FFNet_Pattern_ActivationList_checkDimensions (FFNet me, Pattern p, ActivationList a) {
	if (my nInputs != p -> nx) {
...
static void _FFNet_Pattern_ActivationList_learn (FFNet me, Pattern pattern, ActivationList activation, long maxNumOfEpochs, double tolerance, int costFunctionType, bool reset) {
	try {
		_FFNet_Pattern_ActivationList_checkDimensions (me, pattern, activation);
...
void FFNet_Pattern_ActivationList_learnSD (FFNet me, Pattern p, ActivationList a, long maxNumOfEpochs, double tolerance, double learningRate, double momentum, int costFunctionType) {
	...
	_FFNet_Pattern_ActivationList_learn (me, p, a, maxNumOfEpochs, tolerance, costFunctionType, resetMinimizer);
}

void FFNet_Pattern_ActivationList_learnSM (FFNet me, Pattern p, ActivationList a, long maxNumOfEpochs, double tolerance, int costFunctionType) {
	int resetMinimizer = 0;
...
double FFNet_Pattern_ActivationList_getCosts_total (FFNet me, Pattern p, ActivationList a, int costFunctionType) {
	try {
		_FFNet_Pattern_ActivationList_checkDimensions (me, p, a);
		FFNet_setCostFunction (me, costFunctionType);
...
double FFNet_Pattern_ActivationList_getCosts_average (FFNet me, Pattern p, ActivationList a, int costFunctionType) {
	double costs = FFNet_Pattern_ActivationList_getCosts_total (me, p, a, costFunctionType);
...
/* End of file FFNet_Pattern_ActivationList.cpp */
