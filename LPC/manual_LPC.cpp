...
MAN_BEGIN (U"FormantPath", U"djmw", 20200521)
...
NORMAL (U"A FormantPath combines a collection of @@Formant@s with a Sound and a TextGrid. A said before, each of the Formant objects in the collection is the result of a formant analysis with a different parameter settings on the same Sound. For example, consider a collection with nine Formant objects. The formant objects could be the result of @@Sound: To Formant (burg)...@ analyses on the same sound. The only difference in  each analyses was the \"Maximum formant (Hz)\" parameter setting. It was chosen as 4500, 4750, 5000, 5250, 5500, 6750, 6000, 6250 and 6500 Hz, respectively. In this way, the collection functions as a set of alternative analyses. One of the Formants in this set equals the result of a \"standard\" analysis. One of the tiers in the TextGrid keeps tract of which aternative has been chosen for a particular interval in time.")
