...
LIST_ITEM (U"\\bu @@Sound: To Pitch (filtered ac)...")
LIST_ITEM (U"\\bu @@Sound: To Pitch (raw cc)...")
LIST_ITEM (U"\\bu @@Sound: To Pitch (raw ac)...")
LIST_ITEM (U"\\bu @@Sound: To Pitch (filtered cc)...")
...
NORMAL (U"You can undo these commands with Undo (@@Keyboard shortcuts|Command-Z@).")
...
ENTRY (U"Settings")
TERM (U"##New average intensity (dB SPL)")
