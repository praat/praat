...
MAN_BEGIN (U"Scripting 2. How to script settings windows", U"ppgb", 20201229)
...
MAN_BEGIN (U"Scripting 5.7. Vectors and matrices", U"ppgb", 20201229)
...
NORMAL (U"creates a vector containing the strings \"Hello,\", \"how\", \"are\", and \"you?\".")
MAN_END
...
TAG (U"#text: %numberOfLines, %%variable\\$ %, %%initialValue\\$ %")
...
TAG (U"#realvector: %%variable\\$ %, %%format\\$ %, %%initialValue\\$ %")
...
TAG (U"#realvector: %numberOfLines, %%variable\\$ %, %%format\\$ %, %%initialValue\\$ %")
DEFINITION (U"use this if you want a field with less or more than the standard 7 lines.")
TAG (U"#positivevector: %%variable\\$ %, %%format\\$ %, %%initialValue\\$ %")
TAG (U"#positivevector: %numberOfLines, %%variable\\$ %, %%format\\$ %, %%initialValue\\$ %")
DEFINITION (U"use either of these if you want to check that all initial elements are positive real numbers.")
TAG (U"#integervector: %%variable\\$ %, %%format\\$ %, %%initialValue\\$ %")
TAG (U"#integervector: %numberOfLines, %%variable\\$ %, %%format\\$ %, %%initialValue\\$ %")
DEFINITION (U"use either of these if you want to check that all initial elements are whole numbers.")
TAG (U"#naturalvector: %%variable\\$ %, %%format\\$ %, %%initialValue\\$ %")
TAG (U"#naturalvector: %numberOfLines, %%variable\\$ %, %%format\\$ %, %%initialValue\\$ %")
...
MAN_BEGIN (U"Scripting 6.6. Controlling the user", U"ppgb", 20230122)
