...
enums_begin (kPraatTests, 0)
	...
	enums_add (kPraatTests, 26, TIME_OUTER_NUMMAT, U"TimeOuter##")
	enums_add (kPraatTests, 27, CHECK_INVFISHERQ, U"invFisherQ(0.003,1,100000)")
	enums_add (kPraatTests, 28, THING_AUTO, U"ThingAuto")
enums_end (kPraatTests, 28, CHECK_RANDOM_1009_2009)
