...
EditorPrefs_begin (TextGridEditor)
	...
	EditorInstancePrefs_addString       (TextGridEditor, greenString,            1, U"some text here for green paint")
	...
	EditorInstancePrefs_addString       (TextGridEditor, align_language,         1, U"English")
