...
MAN_BEGIN (L"Keyboard shortcuts", L"ppgb", 20030316)
...
NORMAL (L"to choose a menu command with the keyboard. All of these commands can also be chosen "
	"from a menu.")
ENTRY (L"Command key")
NORMAL (L"When mentioning the %%Command key%, this manual refers to the key immediately to the left "
...
NORMAL (L"On Macintosh, this key is labelled with an Apple. On SGI, this key is labelled #Alt. ")
ENTRY (L"Option key")
NORMAL (L"When mentioning the %%Option key%, this manual refers to the key immediately to the left "
...
NORMAL (L"On Macintosh, this key may be labelled #Option or #Alt. On SGI, this key is labelled #Ctrl. ")
MAN_END
