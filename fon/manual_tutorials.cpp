...
LIST_ITEM (L"• Graphics: added the Chinese phonetic symbols \\id and \\ir. See @@Phonetic symbols: vowels@.")
...
LIST_ITEM (L"• Manual: documentation of explicit formulas for @@Voice 2. Jitter|jitter measurements@.")
NORMAL (L"##5.2.15# (11 February 2011)")
LIST_ITEM (L"• @@Sounds: Concatenate with overlap...@.")
...
LIST_ITEM (L"• Scripting: allow directory (folder) selector windows; see @@Scripting 6.6. Controlling the user@.")
...
LIST_ITEM (L"• Scripting: support for numeric @@Scripting 5.6. Arrays|arrays@.")
MAN_END
...
LIST_ITEM (L"• Scripting: support for stand-alone programs; see @@Scripting 9.1. Turning a script into a stand-alone program@.")
...
LIST_ITEM (L"• Scripting: allow file selector windows; see @@Scripting 6.6. Controlling the user@.")
...
LIST_ITEM (L"• Allowed multiple files to be selected with e.g. @@Read from file...@.")
...
LIST_ITEM (L"• Extensive pause windows: @@Scripting 6.6. Controlling the user@.")
...
LIST_ITEM (L"• Contributed by Ola Söder: @@kNN classifiers@ and @@k-means clustering@.")
...
LIST_ITEM (L"• OT learning: added @@OTGrammar & PairDistribution: Find positive weights...@.")
...
LIST_ITEM (L"• More extensive @@logistic regression@.")
...
LIST_ITEM (L"• Corrected yet another bug in the new @@Sound: To TextGrid (silences)...@.")
NORMAL (L"##4.5.01# (28 October 2006)")
LIST_ITEM (L"• Sound window: the pitch drawing method is #Curves, #Speckles, or #Automatic.")
LIST_ITEM (L"• Corrected another bug in the new @@Sound: To TextGrid (silences)...@.")
MAN_END
...
LIST_ITEM (L"• Corrected a bug in the new @@Sound: To TextGrid (silences)...@.")
...
LIST_ITEM (L"• Scripting: more techniques for @@Scripting 4. Object selection|object selection@.")
...
LIST_ITEM (L"• Support for @@plug-ins@.")
LIST_ITEM (L"• Split between @@Create Strings as file list...@ and @@Create Strings as directory list...@.")
...
LIST_ITEM (L"• Scripting: replacing with regular expression. See @@Formulas 5. String functions@.")
...
LIST_ITEM (L"• Formulas: @@Formulas 7. Attributes of objects|row\\$  and col\\$  attributes@.")
...
ENTRY (L"Praat 4.1, 5 June 2003")
	...
	LIST_ITEM (L"• Editors: @@Intro 3.6. Viewing a spectral slice@.")
	...
	LIST_ITEM (L"• New functions: date\\$ (), extractNumber, extractWord\\$ , extractLine\\$ . See @@Formulas 5. String functions@.")
...
ENTRY (L"Praat 4.0, 15 October 2001")
	...
	LIST_ITEM (L"• @@Regular expressions@.")
	NORMAL (L"Scripting:")
...
ENTRY (L"Praat 3.9, 18 October 2000")
	...
	LIST_ITEM (L"• @@TableOfReal: Draw box plots...@.")
	LIST_ITEM (L"• @@Covariance: To TableOfReal (random sampling)...@.")
	LIST_ITEM (L"• @@SSCP: Get sigma ellipse area...@.")
...
ENTRY (L"Praat 3.8, 12 January 1999")
	...
	LIST_ITEM (L"• @@Sound: Get nearest zero crossing...@.")
...
ENTRY (L"Praat 3.7, 24 March 1998")
	...
	LIST_ITEM (L"• @@TextGrid: Count labels...@.")
	...
	LIST_ITEM (L"• Eight new functions like e.g. %hertzToBark in @@Formulas 4. Mathematical functions@.")
...
ENTRY (L"Praat 3.6, 27 October 1997")
	...
	NORMAL (L"Phonology library")
	LIST_ITEM (L"• Computational Optimality Theory. See @@OT learning@.")
	NORMAL (L"Hypertext")
	...
	LIST_ITEM (L"• Use platform-independent relative file paths in @@Praat script@.")
	LIST_ITEM (L"• @ScriptEditor: Run selection.")
	NORMAL (L"Graphics:")
	LIST_ITEM (L"• Rotation and scaling while printing the @@Picture window@.")
...
LIST_ITEM (L"Ola Söder: @@kNN classifiers@, @@k-means clustering@.")
