...
void structPointEditor :: v_draw () {
	...
	if (sound != NULL && (d_sound_scalingStrategy == kTimeSoundEditor_scalingStrategy_BY_WINDOW || d_sound_scalingStrategy == kTimeSoundEditor_scalingStrategy_BY_WINDOW_AND_CHANNEL)) {
		long first, last;
