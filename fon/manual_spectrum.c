...
MAN_BEGIN ("Sound: To Spectrogram...", "ppgb", 20070225)
...
CODE ("Create Sound from formula... gauss Mono 0 1 22050 sin(2*pi*1000*x) * exp(-3*((x-0.5)/0.1)\\^ 2)")
...
CODE ("Create Sound from formula... Hamming Mono 0 1 22050 if x<0.4 or x>0.6 then 0 else sin(2*pi*1000*x)*(0.54+0.46*cos(pi*(x-0.5)/0.1)) fi")
CODE ("To Spectrum (fft)")
...
CODE ("Create Sound from formula... rectangular Mono 0 1 22050 if x<0.4 or x>0.6 then 0 else sin(2*pi*1000*x) fi")
CODE ("To Spectrum (fft)")
CODE ("Formula... if x<970 or x>1030 then 0 else self fi")
CODE ("To Formant (peaks)... 20")
CODE ("Write to console")
...
CODE ("Create Sound from formula... Hanning Mono 0 1 22050 if x<0.4 or x>0.6 then 0 else sin(2*pi*1000*x)*(0.5+0.5*cos(pi*(x-0.5)/0.1)) fi")
CODE ("To Spectrum (fft)")
CODE ("Formula... if x<970 or x>1030 then 0 else self fi")
CODE ("To Formant (peaks)... 20")
CODE ("Write to console")
...
CODE ("Create Sound from formula... triangular Mono 0 1 22050 if x<0.4 or x>0.6 then 0 else sin(2*pi*1000*x)*(1-abs((x-0.5)/0.1)) fi")
CODE ("To Spectrum (fft)")
CODE ("Formula... if x<970 or x>1030 then 0 else self fi")
CODE ("To Formant (peaks)... 20")
CODE ("Write to console")
...
CODE ("Create Sound from formula... parabolic Mono 0 1 22050 if x<0.4 or x>0.6 then 0 else sin(2*pi*1000*x)*(1-((x-0.5)/0.1)^2) fi")
CODE ("To Spectrum (fft)")
CODE ("Formula... if x<970 or x>1030 then 0 else self fi")
CODE ("To Formant (peaks)... 20")
CODE ("Write to console")
...
MAN_BEGIN ("Sound: To Ltas (pitch-corrected)...", "ppgb", 20061203)
...
NORMAL ("The analysis method is described in @@Boersma & Kovacic (2006)@.")
MAN_END
...
MAN_BEGIN ("Spectrum: Get centre of gravity...", "ppgb", 20070225)
INTRO ("A command to query the selected @Spectrum object.")
