...
MAN_BEGIN (L"What's new?", L"ppgb", 20071003)
INTRO (L"Latest changes in Praat.")
/*LIST_ITEM (L"\\bu Manual page about @@drawing a vowel triangle@.")*/
NORMAL (L"##4.6.30# (October 3, 2007)")
...
NORMAL (L"##4.6# (May 12, 2007)")
NORMAL (L"##4.5.26# (May 8, 2007)")
LIST_ITEM (L"\\bu Sound files: reading FLAC audio files (implemented by Erez Volk).")
NORMAL (L"##4.5.25# (May 7, 2007)")
...
NORMAL (L"##4.5.16# (February 22, 2007)")
...
NORMAL (L"##4.5.15# (February 12, 2007)")
...
NORMAL (L"##4.5.08# (December 20, 2006)")
LIST_ITEM (L"\\bu ExperimentMFC: can use stereo sounds.")
NORMAL (L"##4.5.07# (December 16, 2006)")
...
NORMAL (L"##4.5.06# (December 13, 2006)")
...
NORMAL (L"##4.5.05# (December 5, 2006)")
...
NORMAL (L"##4.4.31# (September 23, 2006)")
...
NORMAL (L"##4.4.12# (February 24, 2006)")
...
NORMAL (L"##4.4.11# (February 23, 2006)")
...
NORMAL (L"##4.4.10# (February 20, 2006)")
...
NORMAL (L"##4.4.05# (January 26, 2006)")
...
NORMAL (L"##4.4.04# (January 6, 2006)")
LIST_ITEM (L"\\bu Windows: Quicktime support (see at 4.4.03).")
NORMAL (L"##4.4.03# (January 6, 2006)")
...
NORMAL (L"##4.4# (December 19, 2005)")
NORMAL (L"##4.3.37# (December 15, 2005)")
...
NORMAL (L"##4.3.23# (September 24, 2005)")
...
NORMAL (L"##4.3.20# (August 18, 2005)")
LIST_ITEM (L"\\bu Log files: include name of editor window.")
NORMAL (L"##4.3.19# (July 20, 2005)")
...
NORMAL (L"##4.3.02# (February 16, 2005)")
...
NORMAL (L"##4.3.01# (February 9, 2005)")
...
ENTRY (L"Praat 4.3, January 26, 2005")
	NORMAL (L"General:")
...
ENTRY (L"Praat 4.2, March 4, 2004")
	NORMAL (L"General:")
...
ENTRY (L"Praat 4.0, October 15, 2001")
	NORMAL (L"Editors:")
...
ENTRY (L"Praat 3.9, October 18, 2000")
	NORMAL (L"Editors:")
...
ENTRY (L"Praat 3.8, January 12, 1999")
	NORMAL (L"Phonetics library")
...
ENTRY (L"Praat 3.7, March 24, 1998")
	NORMAL (L"Editors:")
...
ENTRY (L"Praat 3.6, October 27, 1997")
	NORMAL (L"Editors:")
...
ENTRY (L"Praat 3.3, October 6, 1996")
...
ENTRY (L"Praat 3.2, April 29, 1996")
...
ENTRY (L"Praat 3.1, December 5, 1995")
...
MAN_BEGIN (L"Acknowledgments", L"ppgb", 20070602)
NORMAL (L"For supplying source code:")
LIST_ITEM (L"GPL IPA fonts: Fukui Rei (XIPA) & Rafael Laboissi\\e`re (adaptation to Praat).")
LIST_ITEM (L"IPA fonts: Summer Institute of Linguistics (Doulos1989, until January 2005).")
LIST_ITEM (L"Linux audio: Darryl Purnell, Pretoria.")
LIST_ITEM (L"GPL Gnu Scientific Library: Gerard Jungman, Brian Gough.")
LIST_ITEM (L"PortAudio: Ross Bencina, Phil Burk, Bjorn Roche, Dominic Mazzoni, Darren Gibbs.")
LIST_ITEM (L"MPEG Audio Decoder: Underbit Technologies; adaptation to Praat by Erez Volk.")
LIST_ITEM (L"Free Lossless Audio Codec: Josh Coalson; adaptation to Praat by Erez Volk.")
LIST_ITEM (L"Public domain Fourier transforms: Paul Swarztrauber (fftpack), Monty.")
LIST_ITEM (L"Public domain LAPACK: Univ. of Tennessee, Univ. of California Berkeley, NAG Ltd., "
