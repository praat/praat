...
LIST_ITEM ("\\bu OTGrammar: positive constraint satisfactions are drawn as `+' in tableaus.")
...
NORMAL ("##4.6.06# (June 4, 2007)")
LIST_ITEM ("\\bu Script window: corrected a bug introduced in 4.6.05 that could cause incorrect symbols in saved files.")
...
LIST_ITEM ("\\bu Spectral slices have better names.")
NORMAL ("##4.6.02# (May 17, 2007)")
LIST_ITEM ("\\bu Sound files: writing FLAC audio files (implemented by Erez Volk).")
...
LIST_ITEM ("\\bu Sound files: reading FLAC audio files (implemented by Erez Volk).")
...
ENTRY ("Praat 4.3, January 26, 2005")
	...
	LIST_ITEM ("\\bu Sound: To Spectrum... now has a reasonably fast non-FFT version.")
	...
	NORMAL ("Voice:")
	LIST_ITEM ("\\bu July 9, 2004 (4.2.08): Shimmer measurements: more accurate and less sensitive to additive noise.")
	...
	LIST_ITEM ("\\bu Subjects can now respond with keyboard presses.")
	NORMAL ("Graphics:")
	...
	NORMAL ("OT learning:")
	LIST_ITEM ("\\bu Monitor rankings when learning.")
	LIST_ITEM ("\\bu OTGrammar: Remove harmonically bounded candidates...")
	LIST_ITEM ("\\bu OTGrammar: Write to headerless spreadsheet file...")
	LIST_ITEM ("\\bu Metrics grammar: added *Clash, *Lapse, WeightByPosition and *MoraicConsonant.")
	NORMAL ("Scripting:")
	LIST_ITEM ("\\bu nowarn, noprogress, nocheck.")
	LIST_ITEM ("\\bu Line numbers.")
...
ENTRY ("Praat 4.1, June 5, 2003")
	...
	LIST_ITEM ("\\bu Overlap-add synthesis: reduced buzz in voiceless parts.")
...
ENTRY ("Praat 3.8, January 12, 1999")
	...
	LIST_ITEM ("\\bu @@Overlap-add@ manipulation of voiceless intervals, version 2: quality much better now; "
...
ENTRY ("Praat 3.7, March 24, 1998")
	...
	LIST_ITEM ("\\bu Sound enhancements: @@Sound: Lengthen (overlap-add)...@, @@Sound: Deepen band modulation...@")
...
ENTRY ("Praat 3.2, April 29, 1996")
	...
	LIST_ITEM ("\\bu Overlap-add pitch manipulation.")
...
LIST_ITEM ("\\bu @Manipulation (@ManipulationEditor): @@overlap-add@")
