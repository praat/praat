...
NORMAL ("##4.2# (March 4, 2004)")
NORMAL ("##4.1.28# (February 17, 2004)")
LIST_ITEM ("\\bu Better selections in Picture window and editor windows.")
NORMAL ("##4.1.27# (February 11, 2004)")
...
NORMAL ("##4.1.25# (January 29, 2004)")
LIST_ITEM ("\\bu Optimality Theory: metrics grammar supports \'impoverished overt forms\', "
...
LIST_ITEM ("\\bu MacOS X: removed a bug by which the script editor did not always know that the text had changed.")
LIST_ITEM ("\\bu Windows: in EPS files use Times New Roman instead of Times.")
NORMAL ("##4.1.24# (January 13, 2004)")
LIST_ITEM ("\\bu MacOS X: removed a major bug introduced in 4.1.22 that caused text fields to be unclickable.")
NORMAL ("##4.1.23# (January 11, 2004)")
LIST_ITEM ("\\bu MacOS X: removed a serious bug introduced in 4.1.22 that caused loss of text when saving and running scripts.")
LIST_ITEM ("\\bu Macintosh: removed a bug that could cause wrong line widths in copied pictures.")
...
NORMAL ("##4.1.22# (January 7, 2004)")
LIST_ITEM ("\\bu Script editor: support for unlimited size of script files in editor window on Windows XP and MacOS X (the Unix editions already had this).")
LIST_ITEM ("\\bu Script editor: better scrolling of text on Windows XP and MacOS X (the Unix editions already had this).")
LIST_ITEM ("\\bu Inspect: removed several bugs that caused ugly scrolling of text fields.")
NORMAL ("##4.1.21# (December 15, 2003)")
LIST_ITEM ("\\bu Removed a major bug introduced in 4.1.16 that caused a Sound to change when computing an Intensity from it.")
NORMAL ("##4.1.20# (December 9, 2003)")
LIST_ITEM ("\\bu Removed a major bug introduced in 4.1.19 that could give weird analysis settings "
	"in the sound editor window, or \"Wrong field in dialog; notify author.\" crashes.")
NORMAL ("##4.1.19# (December 3, 2003)")
LIST_ITEM ("\\bu Editor windows give better feedback of undersampling.")
LIST_ITEM ("\\bu Windows: repaired an age-old bug by which the Picture window could not be closed twice.")
LIST_ITEM ("\\bu SoundEditor gives more complete settings report.")
NORMAL ("##4.1.18# (November 26, 2003)")
LIST_ITEM ("\\bu Repaired a small memory leak in Sound: To Manipulation.")
LIST_ITEM ("\\bu Manual pages: variable duration of recording.")
NORMAL ("##4.1.17# (November 20, 2003)")
LIST_ITEM ("\\bu PitchTier: improved Interpolate quadratically.")
NORMAL ("##4.1.16# (November 19, 2003)")
LIST_ITEM ("\\bu PitchTier: Interpolate quadratically.")
NORMAL ("##4.1.15# (November 7, 2003)")
LIST_ITEM ("\\bu More phonetic diacritics.")
NORMAL ("##4.1.14# (October 29, 2003)")
LIST_ITEM ("\\bu TextGrids can be saved chronologically (and Praat can read that file again).")
NORMAL ("##4.1.13# (October 22, 2003)")
LIST_ITEM ("\\bu Removed a bug that caused @@Matrix: Solve equation...@ to generate an "
	"incorrect result and sometimes crash P\\s{RAAT} whenever the number of rows "
	"was larger than the number of columns.")
LIST_ITEM ("\\bu Linux: removed a bug that caused P\\s{RAAT} to play sounds at double speed for some sound cards.")
LIST_ITEM ("\\bu @@OT learning@: full support for crucially tied constraints and tied candidates; "
	"queries for testing grammaticality.")
NORMAL ("##4.1.12# (October 17, 2003)")
LIST_ITEM ("\\bu @@OT learning@: some support for crucial ties and backtracking in EDCD.")
NORMAL ("##4.1.11# (October 9, 2003)")
LIST_ITEM ("\\bu Removed a bug that caused Praat to crash whenever \"Extract intervals\" "
	"found an interval with a label longer than 200 characters.")
NORMAL ("##4.1.10# (October 3, 2003)")
...
NORMAL ("##4.1.9# (September 27, 2003)")
LIST_ITEM ("\\bu Removed a major bug introduced by the new FFT algorithms in version 4.1.3, "
	"which caused a doubling of the amplitude when resampling or filtering a sound, "
	"and an octave jump when smoothing a pitch curve.")
NORMAL ("##4.1.8# (September 17, 2003)")
...
NORMAL ("##4.1.7# (September 12, 2003)")
LIST_ITEM ("\\bu Sound Designer II support (reading and opening).")
LIST_ITEM ("\\bu Sound window scripting: corrected extraction of spectrogram/pitch/formant/pulses.")
NORMAL ("##4.1.6# (August 22, 2003)")
LIST_ITEM ("\\bu MacOS X: prevented SoundRecorder from crashing Praat in case of loud signals on some computers.")
LIST_ITEM ("\\bu Sun workstations: support audio servers.")
NORMAL ("##4.1.4# (July 10, 2003)")
LIST_ITEM ("\\bu Open source code (General Public Licence).")
LIST_ITEM ("\\bu More precision in numeric libraries.")
NORMAL ("##4.1.3# (July 2, 2003)")
LIST_ITEM ("\\bu Faster computation of spectrum, spectrogram, and pitch.")
NORMAL ("##4.1.2# (June 19, 2003)")
LIST_ITEM ("\\bu Ltas: Compute trend line, Subtract trend line.")
NORMAL ("##4.1.1# (June 5, 2003)")
LIST_ITEM ("\\bu Formulas for PitchTier, IntensityTier, AmplitudeTier, DurationTier.")
LIST_ITEM ("\\bu Jitter: corrected the computation of PPQ5 (divide by %N-4 instead of %N-2).")
...
MAN_BEGIN ("Intro 2.2. Viewing and editing a sound", "ppgb", 20041126)
...
NORMAL ("If your sound file is longer than a couple of minutes, you may prefer to open it with @@Open long sound file...@. "
