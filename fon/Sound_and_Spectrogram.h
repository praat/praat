 ...
 *
 * Copyright (C) 1992-2011,2015-2017,2025 Paul Boersma
 *
...
autoSpectrogram Sound_to_Spectrogram_e (
	constSound me,
	double effectiveAnalysisWidth,
	double fmax,
	double minimumTimeStep1,
	double minimumFreqStep1,
	kSound_to_Spectrogram_windowShape windowShape,
	double maximumTimeOversampling,
	double maximumFreqOversampling
);
