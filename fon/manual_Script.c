...
MAN_BEGIN (L"Formulas 3. Constants", L"ppgb", 20030211)
TAG (L"##pi")
DEFINITION (L"%\\pi, 3.14159265358979323846")
TAG (L"##e")
DEFINITION (L"%e, 2.7182818284590452354")
TAG (L"##undefined")
DEFINITION (L"a special value, see @undefined")
MAN_END

MAN_BEGIN (L"Formulas 4. Mathematical functions", L"ppgb", 20060804)
TAG (L"##abs (%x)")
