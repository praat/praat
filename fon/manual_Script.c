...
MAN_BEGIN ("Formulas 4. Mathematical functions", "ppgb", 20060804)
TAG ("##abs (%x)")
...
MAN_BEGIN ("Formulas 5. String functions", "ppgb", 20060610)
...
MAN_BEGIN ("Scripting 4. Object selection", "ppgb", 20060930)
...
NORMAL ("To get the full name (type + name) of the third selected object, you do:")
CODE ("fullName\\$  = ##selected\\$ # (3)")
NORMAL ("To get the full name of the topmost selected object, you do:")
CODE ("fullName\\$  = ##selected\\$ # ()")
NORMAL ("To get the type and name out of the full name, you do:")
CODE ("type\\$  = extractWord\\$  (fullName\\$ , \"\")")
CODE ("name\\$  = extractLine\\$  (fullName\\$ , \" \")")
NORMAL ("Negative numbers count from the bottom. Thus, to get the name of the bottom-most selected Sound "
	"object, you say")
CODE ("name\\$  = ##selected\\$ # (\"Sound\", -1)")
...
CODE ("\\#  Correct:")
CODE ("#select sound")
NORMAL ("To get the number of selected Sound objects into a variable, use")
CODE ("numberOfSelectedSounds = numberOfSelected (\"Sound\")")
NORMAL ("To get the number of selected objects into a variable, use")
CODE ("numberOfSelectedObjects = numberOfSelected ()")
ENTRY ("Example: doing something to every selected Sound")
CODE ("n = numberOfSelected (\"Sound\")")
CODE ("for i to n")
CODE1 ("sound'i' = selected (\"Sound\", i)")
CODE ("endfor")
CODE ("\\#  Median pitches of all selected sounds:")
CODE ("for i to n")
CODE1 ("select sound'i'")
CODE1 ("To Pitch... 0.0 75 600")
CODE1 ("f0 = Get quantile... 0 0 0.50 Hertz")
CODE1 ("Remove")
CODE ("endfor")
CODE ("\\#  Restore selection:")
CODE ("if n >= 1")
CODE1 ("select sound1")
CODE1 ("for i from 2 to n")
CODE2 ("plus sound'i'")
CODE1 ("endfor")
CODE ("endif")
MAN_END
...
MAN_BEGIN ("Script for analysing pitch with a TextGrid", "ppgb", 20051112)
