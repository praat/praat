...
static struct { char first, second; bool isSpace, isWordCharacter; } genericDigraph [1+UNICODE_TOP_GENERICIZABLE];

inline static void makeWordCharacters (char32 from, char32 to) {
	for (char32 kar = from; kar <= to; kar ++) {
		genericDigraph [kar]. isWordCharacter = true;
	}
}
...
void Longchar_init () {
	...
	makeWordCharacters (U'\u0041', U'\u005A');
	makeWordCharacters (U'\u0061', U'\u007A');
	makeWordCharacters (U'\u00C0', U'\u00D6');
	makeWordCharacters (U'\u00D8', U'\u00F6');
	makeWordCharacters (U'\u00F8', U'\u02C1');
	makeWordCharacters (U'\u02C6', U'\u02D1');
	makeWordCharacters (U'\u02E0', U'\u02E4');
	genericDigraph [U'\u02EC']. isWordCharacter = true;
	genericDigraph [U'\u02EE']. isWordCharacter = true;
	makeWordCharacters (U'\u0370', U'\u0374');
	genericDigraph [U'\u0376']. isWordCharacter = true;
	genericDigraph [U'\u0377']. isWordCharacter = true;
	makeWordCharacters (U'\u037A', U'\u037D');
	genericDigraph [U'\u0386']. isWordCharacter = true;
	makeWordCharacters (U'\u0388', U'\u038A');
	genericDigraph [U'\u038C']. isWordCharacter = true;
	makeWordCharacters (U'\u038E', U'\u03A1');
	makeWordCharacters (U'\u03A3', U'\u03F5');
	makeWordCharacters (U'\u03F7', U'\u0481');
	makeWordCharacters (U'\u048A', U'\u0527');
	makeWordCharacters (U'\u0531', U'\u0556');
	genericDigraph [U'\u0559']. isWordCharacter = true;
	makeWordCharacters (U'\u0561', U'\u0587');
	makeWordCharacters (U'\u05D0', U'\u05EA');
	makeWordCharacters (U'\u05F0', U'\u05F2');
	makeWordCharacters (U'\u0620', U'\u064A');
	genericDigraph [U'\u066E']. isWordCharacter = true;
	genericDigraph [U'\u066F']. isWordCharacter = true;
	makeWordCharacters (U'\u0671', U'\u06D3');
	genericDigraph [U'\u06D5']. isWordCharacter = true;
	genericDigraph [U'\u06E5']. isWordCharacter = true;
	genericDigraph [U'\u06E6']. isWordCharacter = true;
	genericDigraph [U'\u06EE']. isWordCharacter = true;
	genericDigraph [U'\u06EF']. isWordCharacter = true;
	makeWordCharacters (U'\u06FA', U'\u06FC');
	genericDigraph [U'\u06FF']. isWordCharacter = true;
	genericDigraph [U'\u0710']. isWordCharacter = true;
	makeWordCharacters (U'\u0712', U'\u072F');
	makeWordCharacters (U'\u074D', U'\u07A5');
	genericDigraph [U'\u07B1']. isWordCharacter = true;
	makeWordCharacters (U'\u07CA', U'\u07EA');
	genericDigraph [U'\u07F4']. isWordCharacter = true;
	genericDigraph [U'\u07F5']. isWordCharacter = true;
	genericDigraph [U'\u07FA']. isWordCharacter = true;
	makeWordCharacters (U'\u0800', U'\u0815');
	genericDigraph [U'\u081A']. isWordCharacter = true;
	genericDigraph [U'\u0824']. isWordCharacter = true;
	genericDigraph [U'\u0828']. isWordCharacter = true;
	makeWordCharacters (U'\u0840', U'\u0858');
	genericDigraph [U'\u08A0']. isWordCharacter = true;
	makeWordCharacters (U'\u08A2', U'\u08AC');
	makeWordCharacters (U'\u0904', U'\u0939');
	genericDigraph [U'\u093D']. isWordCharacter = true;
	genericDigraph [U'\u0950']. isWordCharacter = true;
	makeWordCharacters (U'\u0958', U'\u0961');
	makeWordCharacters (U'\u0971', U'\u0977');
	makeWordCharacters (U'\u0979', U'\u097F');
	makeWordCharacters (U'\u0985', U'\u098C');
	genericDigraph [U'\u098F']. isWordCharacter = true;
	genericDigraph [U'\u0990']. isWordCharacter = true;
	makeWordCharacters (U'\u0993', U'\u09A8');
	makeWordCharacters (U'\u09AA', U'\u09B0');
	genericDigraph [U'\u09B2']. isWordCharacter = true;
	makeWordCharacters (U'\u09B6', U'\u09B9');
	genericDigraph [U'\u09BD']. isWordCharacter = true;
	genericDigraph [U'\u09CE']. isWordCharacter = true;
	genericDigraph [U'\u09DC']. isWordCharacter = true;
	genericDigraph [U'\u09DD']. isWordCharacter = true;
	makeWordCharacters (U'\u09DF', U'\u09E1');
	genericDigraph [U'\u09F0']. isWordCharacter = true;
	genericDigraph [U'\u09F1']. isWordCharacter = true;
	makeWordCharacters (U'\u0A05', U'\u0A0A');
	genericDigraph [U'\u0A0F']. isWordCharacter = true;
	genericDigraph [U'\u0A10']. isWordCharacter = true;
	makeWordCharacters (U'\u0A13', U'\u0A28');
	makeWordCharacters (U'\u0A2A', U'\u0A30');
	genericDigraph [U'\u0A32']. isWordCharacter = true;
	genericDigraph [U'\u0A33']. isWordCharacter = true;
	genericDigraph [U'\u0A35']. isWordCharacter = true;
	genericDigraph [U'\u0A36']. isWordCharacter = true;
	genericDigraph [U'\u0A38']. isWordCharacter = true;
	genericDigraph [U'\u0A39']. isWordCharacter = true;
	makeWordCharacters (U'\u0A59', U'\u0A5C');
	genericDigraph [U'\u0A5E']. isWordCharacter = true;
	makeWordCharacters (U'\u0A72', U'\u0A74');
	makeWordCharacters (U'\u0A85', U'\u0A8D');
	makeWordCharacters (U'\u0A8F', U'\u0A91');
	makeWordCharacters (U'\u0A93', U'\u0AA8');
	makeWordCharacters (U'\u0AAA', U'\u0AB0');
	genericDigraph [U'\u0AB2']. isWordCharacter = true;
	genericDigraph [U'\u0AB3']. isWordCharacter = true;
	makeWordCharacters (U'\u0AB5', U'\u0AB9');
	genericDigraph [U'\u0ABD']. isWordCharacter = true;
	genericDigraph [U'\u0AD0']. isWordCharacter = true;
	genericDigraph [U'\u0AE0']. isWordCharacter = true;
	genericDigraph [U'\u0AE1']. isWordCharacter = true;
	makeWordCharacters (U'\u0B05', U'\u0B0C');
	genericDigraph [U'\u0B0F']. isWordCharacter = true;
	genericDigraph [U'\u0B10']. isWordCharacter = true;
	makeWordCharacters (U'\u0B13', U'\u0B28');
	makeWordCharacters (U'\u0B2A', U'\u0B30');
	genericDigraph [U'\u0B32']. isWordCharacter = true;
	genericDigraph [U'\u0B33']. isWordCharacter = true;
	makeWordCharacters (U'\u0B35', U'\u0B39');
	genericDigraph [U'\u0B3D']. isWordCharacter = true;
	genericDigraph [U'\u0B5C']. isWordCharacter = true;
	genericDigraph [U'\u0B5D']. isWordCharacter = true;
	makeWordCharacters (U'\u0B5F', U'\u0B61');
	genericDigraph [U'\u0B71']. isWordCharacter = true;
	genericDigraph [U'\u0B83']. isWordCharacter = true;
	makeWordCharacters (U'\u0B85', U'\u0B8A');
	makeWordCharacters (U'\u0B8E', U'\u0B90');
	makeWordCharacters (U'\u0B92', U'\u0B95');
	genericDigraph [U'\u0B99']. isWordCharacter = true;
	genericDigraph [U'\u0B9A']. isWordCharacter = true;
	genericDigraph [U'\u0B9C']. isWordCharacter = true;
	genericDigraph [U'\u0B9E']. isWordCharacter = true;
	genericDigraph [U'\u0B9F']. isWordCharacter = true;
	genericDigraph [U'\u0BA3']. isWordCharacter = true;
	genericDigraph [U'\u0BA4']. isWordCharacter = true;
	makeWordCharacters (U'\u0BA8', U'\u0BAA');
	makeWordCharacters (U'\u0BAE', U'\u0BB9');
	genericDigraph [U'\u0BD0']. isWordCharacter = true;
	makeWordCharacters (U'\u0C05', U'\u0C0C');
	makeWordCharacters (U'\u0C0E', U'\u0C10');
	makeWordCharacters (U'\u0C12', U'\u0C28');
	makeWordCharacters (U'\u0C2A', U'\u0C33');
	makeWordCharacters (U'\u0C35', U'\u0C39');
	genericDigraph [U'\u0C3D']. isWordCharacter = true;
	genericDigraph [U'\u0C58']. isWordCharacter = true;
	genericDigraph [U'\u0C59']. isWordCharacter = true;
	genericDigraph [U'\u0C60']. isWordCharacter = true;
	genericDigraph [U'\u0C61']. isWordCharacter = true;
	makeWordCharacters (U'\u0C85', U'\u0C8C');
	makeWordCharacters (U'\u0C8E', U'\u0C90');
	makeWordCharacters (U'\u0C92', U'\u0CA8');
	makeWordCharacters (U'\u0CAA', U'\u0CB3');
	makeWordCharacters (U'\u0CB5', U'\u0CB9');
	genericDigraph [U'\u0CBD']. isWordCharacter = true;
	genericDigraph [U'\u0CDE']. isWordCharacter = true;
	genericDigraph [U'\u0CE0']. isWordCharacter = true;
	genericDigraph [U'\u0CE1']. isWordCharacter = true;
	genericDigraph [U'\u0CF1']. isWordCharacter = true;
	genericDigraph [U'\u0CF2']. isWordCharacter = true;
	makeWordCharacters (U'\u0D05', U'\u0D0C');
	makeWordCharacters (U'\u0D0E', U'\u0D10');
	makeWordCharacters (U'\u0D12', U'\u0D3A');
	genericDigraph [U'\u0D3D']. isWordCharacter = true;
	genericDigraph [U'\u0D4E']. isWordCharacter = true;
	genericDigraph [U'\u0D60']. isWordCharacter = true;
	genericDigraph [U'\u0D61']. isWordCharacter = true;
	makeWordCharacters (U'\u0D7A', U'\u0D7F');
	makeWordCharacters (U'\u0D85', U'\u0D96');
	makeWordCharacters (U'\u0D9A', U'\u0DB1');
	makeWordCharacters (U'\u0DB3', U'\u0DBB');
	genericDigraph [U'\u0DBD']. isWordCharacter = true;
	makeWordCharacters (U'\u0DC0', U'\u0DC6');
	makeWordCharacters (U'\u0E01', U'\u0E30');
	genericDigraph [U'\u0E32']. isWordCharacter = true;
	genericDigraph [U'\u0E33']. isWordCharacter = true;
	makeWordCharacters (U'\u0E40', U'\u0E46');
	genericDigraph [U'\u0E81']. isWordCharacter = true;
	genericDigraph [U'\u0E82']. isWordCharacter = true;
	genericDigraph [U'\u0E84']. isWordCharacter = true;
	genericDigraph [U'\u0E87']. isWordCharacter = true;
	genericDigraph [U'\u0E88']. isWordCharacter = true;
	genericDigraph [U'\u0E8A']. isWordCharacter = true;
	genericDigraph [U'\u0E8D']. isWordCharacter = true;
	makeWordCharacters (U'\u0E94', U'\u0E97');
	makeWordCharacters (U'\u0E99', U'\u0E9F');
	makeWordCharacters (U'\u0EA1', U'\u0EA3');
	genericDigraph [U'\u0EA5']. isWordCharacter = true;
	genericDigraph [U'\u0EA7']. isWordCharacter = true;
	genericDigraph [U'\u0EAA']. isWordCharacter = true;
	genericDigraph [U'\u0EAB']. isWordCharacter = true;
	makeWordCharacters (U'\u0EAD', U'\u0EB0');
	genericDigraph [U'\u0EB2']. isWordCharacter = true;
	genericDigraph [U'\u0EB3']. isWordCharacter = true;
	genericDigraph [U'\u0EBD']. isWordCharacter = true;
	makeWordCharacters (U'\u0EC0', U'\u0EC4');
	genericDigraph [U'\u0EC6']. isWordCharacter = true;
	makeWordCharacters (U'\u0EDC', U'\u0EDF');
	genericDigraph [U'\u0F00']. isWordCharacter = true;
	makeWordCharacters (U'\u0F40', U'\u0F47');
	makeWordCharacters (U'\u0F49', U'\u0F6C');
	makeWordCharacters (U'\u0F88', U'\u0F8C');
	makeWordCharacters (U'\u1000', U'\u102A');
	genericDigraph [U'\u103F']. isWordCharacter = true;
	makeWordCharacters (U'\u1050', U'\u1055');
	makeWordCharacters (U'\u105A', U'\u105D');
	genericDigraph [U'\u1061']. isWordCharacter = true;
	genericDigraph [U'\u1065']. isWordCharacter = true;
	genericDigraph [U'\u1066']. isWordCharacter = true;
	makeWordCharacters (U'\u106E', U'\u1070');
	makeWordCharacters (U'\u1075', U'\u1081');
	genericDigraph [U'\u108E']. isWordCharacter = true;
	makeWordCharacters (U'\u10A0', U'\u10C5');
	genericDigraph [U'\u10C7']. isWordCharacter = true;
	genericDigraph [U'\u10CD']. isWordCharacter = true;
	makeWordCharacters (U'\u10D0', U'\u10FA');
	makeWordCharacters (U'\u10FC', U'\u1248');
	makeWordCharacters (U'\u124A', U'\u124D');
	makeWordCharacters (U'\u1250', U'\u1256');
	genericDigraph [U'\u1258']. isWordCharacter = true;
	makeWordCharacters (U'\u125A', U'\u125D');
	makeWordCharacters (U'\u1260', U'\u1288');
	makeWordCharacters (U'\u128A', U'\u128D');
	makeWordCharacters (U'\u1290', U'\u12B0');
	makeWordCharacters (U'\u12B2', U'\u12B5');
	makeWordCharacters (U'\u12B8', U'\u12BE');
	genericDigraph [U'\u12C0']. isWordCharacter = true;
	makeWordCharacters (U'\u12C2', U'\u12C5');
	makeWordCharacters (U'\u12C8', U'\u12D6');
	makeWordCharacters (U'\u12D8', U'\u1310');
	makeWordCharacters (U'\u1312', U'\u1315');
	makeWordCharacters (U'\u1318', U'\u135A');
	makeWordCharacters (U'\u1380', U'\u138F');
	makeWordCharacters (U'\u13A0', U'\u13F4');
	makeWordCharacters (U'\u1401', U'\u166C');
	makeWordCharacters (U'\u166F', U'\u167F');
	makeWordCharacters (U'\u1681', U'\u169A');
	makeWordCharacters (U'\u16A0', U'\u16EA');
	makeWordCharacters (U'\u1700', U'\u170C');
	makeWordCharacters (U'\u170E', U'\u1711');
	makeWordCharacters (U'\u1720', U'\u1731');
	makeWordCharacters (U'\u1740', U'\u1751');
	makeWordCharacters (U'\u1760', U'\u176C');
	makeWordCharacters (U'\u176E', U'\u1770');
	makeWordCharacters (U'\u1780', U'\u17B3');
	genericDigraph [U'\u17D7']. isWordCharacter = true;
	genericDigraph [U'\u17DC']. isWordCharacter = true;
	makeWordCharacters (U'\u1820', U'\u1877');
	makeWordCharacters (U'\u1880', U'\u18A8');
	genericDigraph [U'\u18AA']. isWordCharacter = true;
	makeWordCharacters (U'\u18B0', U'\u18F5');
	makeWordCharacters (U'\u1900', U'\u191C');
	makeWordCharacters (U'\u1950', U'\u196D');
	makeWordCharacters (U'\u1970', U'\u1974');
	makeWordCharacters (U'\u1980', U'\u19AB');
	makeWordCharacters (U'\u19C1', U'\u19C7');
	makeWordCharacters (U'\u1A00', U'\u1A16');
	makeWordCharacters (U'\u1A20', U'\u1A54');
	genericDigraph [U'\u1AA7']. isWordCharacter = true;
	makeWordCharacters (U'\u1B05', U'\u1B33');
	makeWordCharacters (U'\u1B45', U'\u1B4B');
	makeWordCharacters (U'\u1B83', U'\u1BA0');
	genericDigraph [U'\u1BAE']. isWordCharacter = true;
	genericDigraph [U'\u1BAF']. isWordCharacter = true;
	makeWordCharacters (U'\u1BBA', U'\u1BE5');
	makeWordCharacters (U'\u1C00', U'\u1C23');
	makeWordCharacters (U'\u1C4D', U'\u1C4F');
	makeWordCharacters (U'\u1C5A', U'\u1C7D');
	makeWordCharacters (U'\u1CE9', U'\u1CEC');
	makeWordCharacters (U'\u1CEE', U'\u1CF1');
	genericDigraph [U'\u1CF5']. isWordCharacter = true;
	genericDigraph [U'\u1CF6']. isWordCharacter = true;
	makeWordCharacters (U'\u1D00', U'\u1DBF');
	makeWordCharacters (U'\u1E00', U'\u1F15');
	makeWordCharacters (U'\u1F18', U'\u1F1D');
	makeWordCharacters (U'\u1F20', U'\u1F45');
	makeWordCharacters (U'\u1F48', U'\u1F4D');
	makeWordCharacters (U'\u1F50', U'\u1F57');
	genericDigraph [U'\u1F59']. isWordCharacter = true;
	genericDigraph [U'\u1F5B']. isWordCharacter = true;
	genericDigraph [U'\u1F5D']. isWordCharacter = true;
	makeWordCharacters (U'\u1F5F', U'\u1F7D');
	makeWordCharacters (U'\u1F80', U'\u1FB4');
	makeWordCharacters (U'\u1FB6', U'\u1FBC');
	genericDigraph [U'\u1FBE']. isWordCharacter = true;
	makeWordCharacters (U'\u1FC2', U'\u1FC4');
	makeWordCharacters (U'\u1FC6', U'\u1FCC');
	makeWordCharacters (U'\u1FD0', U'\u1FD3');
	makeWordCharacters (U'\u1FD6', U'\u1FDB');
	makeWordCharacters (U'\u1FE0', U'\u1FEC');
	makeWordCharacters (U'\u1FF2', U'\u1FF4');
	makeWordCharacters (U'\u1FF6', U'\u1FFC');
	genericDigraph [U'\u2071']. isWordCharacter = true;
	genericDigraph [U'\u207F']. isWordCharacter = true;
	makeWordCharacters (U'\u2090', U'\u209C');
	genericDigraph [U'\u2102']. isWordCharacter = true;
	genericDigraph [U'\u2107']. isWordCharacter = true;
	makeWordCharacters (U'\u210A', U'\u2113');
	genericDigraph [U'\u2115']. isWordCharacter = true;
	makeWordCharacters (U'\u2119', U'\u211D');
	genericDigraph [U'\u2124']. isWordCharacter = true;
	genericDigraph [U'\u2126']. isWordCharacter = true;
	genericDigraph [U'\u2128']. isWordCharacter = true;
	makeWordCharacters (U'\u212A', U'\u212D');
	makeWordCharacters (U'\u212F', U'\u2139');
	makeWordCharacters (U'\u213C', U'\u213F');
	makeWordCharacters (U'\u2145', U'\u2149');
	genericDigraph [U'\u214E']. isWordCharacter = true;
	genericDigraph [U'\u2183']. isWordCharacter = true;
	genericDigraph [U'\u2184']. isWordCharacter = true;
	makeWordCharacters (U'\u2C00', U'\u2C2E');
	makeWordCharacters (U'\u2C30', U'\u2C5E');
	makeWordCharacters (U'\u2C60', U'\u2CE4');
	makeWordCharacters (U'\u2CEB', U'\u2CEE');
	genericDigraph [U'\u2CF2']. isWordCharacter = true;
	genericDigraph [U'\u2CF3']. isWordCharacter = true;
	makeWordCharacters (U'\u2D00', U'\u2D25');
	genericDigraph [U'\u2D27']. isWordCharacter = true;
	genericDigraph [U'\u2D2D']. isWordCharacter = true;
	makeWordCharacters (U'\u2D30', U'\u2D67');
	genericDigraph [U'\u2D6F']. isWordCharacter = true;
	makeWordCharacters (U'\u2D80', U'\u2D96');
	makeWordCharacters (U'\u2DA0', U'\u2DA6');
	makeWordCharacters (U'\u2DA8', U'\u2DAE');
	makeWordCharacters (U'\u2DB0', U'\u2DB6');
	makeWordCharacters (U'\u2DB8', U'\u2DBE');
	makeWordCharacters (U'\u2DC0', U'\u2DC6');
	makeWordCharacters (U'\u2DC8', U'\u2DCE');
	makeWordCharacters (U'\u2DD0', U'\u2DD6');
	makeWordCharacters (U'\u2DD8', U'\u2DDE');
	genericDigraph [U'\u2E2F']. isWordCharacter = true;
	genericDigraph [U'\u3005']. isWordCharacter = true;
	genericDigraph [U'\u3006']. isWordCharacter = true;
	makeWordCharacters (U'\u3031', U'\u3035');
	genericDigraph [U'\u303B']. isWordCharacter = true;
	genericDigraph [U'\u303C']. isWordCharacter = true;
	makeWordCharacters (U'\u3041', U'\u3096');
	makeWordCharacters (U'\u309D', U'\u309F');
	makeWordCharacters (U'\u30A1', U'\u30FA');
	makeWordCharacters (U'\u30FC', U'\u30FF');
	makeWordCharacters (U'\u3105', U'\u312D');
	makeWordCharacters (U'\u3131', U'\u318E');
	makeWordCharacters (U'\u31A0', U'\u31BA');
	makeWordCharacters (U'\u31F0', U'\u31FF');
	makeWordCharacters (U'\u3400', U'\u4DB5');
	makeWordCharacters (U'\u4E00', U'\u9FCC');
	makeWordCharacters (U'\uA000', U'\uA48C');
	makeWordCharacters (U'\uA4D0', U'\uA4FD');
	makeWordCharacters (U'\uA500', U'\uA60C');
	makeWordCharacters (U'\uA610', U'\uA61F');
	genericDigraph [U'\uA62A']. isWordCharacter = true;
	genericDigraph [U'\uA62B']. isWordCharacter = true;
	makeWordCharacters (U'\uA640', U'\uA66E');
	makeWordCharacters (U'\uA67F', U'\uA697');
	makeWordCharacters (U'\uA6A0', U'\uA6E5');
	makeWordCharacters (U'\uA717', U'\uA71F');
	makeWordCharacters (U'\uA722', U'\uA788');
	makeWordCharacters (U'\uA78B', U'\uA78E');
	makeWordCharacters (U'\uA790', U'\uA793');
	makeWordCharacters (U'\uA7A0', U'\uA7AA');
	makeWordCharacters (U'\uA7F8', U'\uA801');
	makeWordCharacters (U'\uA803', U'\uA805');
	makeWordCharacters (U'\uA807', U'\uA80A');
	makeWordCharacters (U'\uA80C', U'\uA822');
	makeWordCharacters (U'\uA840', U'\uA873');
	makeWordCharacters (U'\uA882', U'\uA8B3');
	makeWordCharacters (U'\uA8F2', U'\uA8F7');
	genericDigraph [U'\uA8FB']. isWordCharacter = true;
	makeWordCharacters (U'\uA90A', U'\uA925');
	makeWordCharacters (U'\uA930', U'\uA946');
	makeWordCharacters (U'\uA960', U'\uA97C');
	makeWordCharacters (U'\uA984', U'\uA9B2');
	genericDigraph [U'\uA9CF']. isWordCharacter = true;
	makeWordCharacters (U'\uAA00', U'\uAA28');
	makeWordCharacters (U'\uAA40', U'\uAA42');
	makeWordCharacters (U'\uAA44', U'\uAA4B');
	makeWordCharacters (U'\uAA60', U'\uAA76');
	genericDigraph [U'\uAA7A']. isWordCharacter = true;
	makeWordCharacters (U'\uAA80', U'\uAAAF');
	genericDigraph [U'\uAAB1']. isWordCharacter = true;
	genericDigraph [U'\uAAB5']. isWordCharacter = true;
	genericDigraph [U'\uAAB6']. isWordCharacter = true;
	makeWordCharacters (U'\uAAB9', U'\uAABD');
	genericDigraph [U'\uAAC0']. isWordCharacter = true;
	genericDigraph [U'\uAAC2']. isWordCharacter = true;
	makeWordCharacters (U'\uAADB', U'\uAADD');
	makeWordCharacters (U'\uAAE0', U'\uAAEA');
	makeWordCharacters (U'\uAAF2', U'\uAAF4');
	makeWordCharacters (U'\uAB01', U'\uAB06');
	makeWordCharacters (U'\uAB09', U'\uAB0E');
	makeWordCharacters (U'\uAB11', U'\uAB16');
	makeWordCharacters (U'\uAB20', U'\uAB26');
	makeWordCharacters (U'\uAB28', U'\uAB2E');
	makeWordCharacters (U'\uABC0', U'\uABE2');
	makeWordCharacters (U'\uAC00', U'\uD7A3');
	makeWordCharacters (U'\uD7B0', U'\uD7C6');
	makeWordCharacters (U'\uD7CB', U'\uD7FB');
	makeWordCharacters (U'\uF900', U'\uFA6D');
	makeWordCharacters (U'\uFA70', U'\uFAD9');
	makeWordCharacters (U'\uFB00', U'\uFB06');
	makeWordCharacters (U'\uFB13', U'\uFB17');
	genericDigraph [U'\uFB1D']. isWordCharacter = true;
	makeWordCharacters (U'\uFB1F', U'\uFB28');
	makeWordCharacters (U'\uFB2A', U'\uFB36');
	makeWordCharacters (U'\uFB38', U'\uFB3C');
	genericDigraph [U'\uFB3E']. isWordCharacter = true;
	genericDigraph [U'\uFB40']. isWordCharacter = true;
	genericDigraph [U'\uFB41']. isWordCharacter = true;
	genericDigraph [U'\uFB43']. isWordCharacter = true;
	genericDigraph [U'\uFB44']. isWordCharacter = true;
	makeWordCharacters (U'\uFB46', U'\uFBB1');
	makeWordCharacters (U'\uFBD3', U'\uFD3D');
	makeWordCharacters (U'\uFD50', U'\uFD8F');
	makeWordCharacters (U'\uFD92', U'\uFDC7');
	makeWordCharacters (U'\uFDF0', U'\uFDFB');
	makeWordCharacters (U'\uFE70', U'\uFE74');
	makeWordCharacters (U'\uFE76', U'\uFEFC');
	makeWordCharacters (U'\uFF21', U'\uFF3A');
	makeWordCharacters (U'\uFF41', U'\uFF5A');
	makeWordCharacters (U'\uFF66', U'\uFFBE');
	makeWordCharacters (U'\uFFC2', U'\uFFC7');
	makeWordCharacters (U'\uFFCA', U'\uFFCF');
	makeWordCharacters (U'\uFFD2', U'\uFFD7');
	makeWordCharacters (U'\uFFDA', U'\uFFDC');
	inited = 1;
}
