...
int ogg_stream_init(ogg_stream_state *os,int serialno){
  if(os){
    ...
    os->body_data=(unsigned char *) _Melder_malloc (os->body_storage*sizeof(*os->body_data));
    os->lacing_vals=(int *) _Melder_malloc (os->lacing_storage*sizeof(*os->lacing_vals));
    os->granule_vals=(ogg_int64_t *) _Melder_malloc(os->lacing_storage*sizeof(*os->granule_vals));
