...
/*  -- LAPACK routine (version 3.0) --
    ...
    Z       (input/output) double array, dimension (LDZ,N)
            ...
            Normally Q is the orthogonal matrix generated by dorghr_ after
            the call to dgehrd_ which formed the Hessenberg matrix H.
    ...
    INFO    (output) long
            = 0:  successful exit
            < 0:  if INFO = -i, the i-th argument had an illegal value
            > 0:  if INFO = i, NUMlapack_dhseqr_ failed to compute all of the
