...
INTRO (U"Split the given @Pattern into a fixed number of clusters using the @@k-means clustering|%%k%-means clustering algorithm@. A @Categories object containing numbered categories corresponding to the generated clusters will be created.")
ENTRY (U"Settings")
TAG (U"##k clusters")
...
INTRO (U"Generate a @Dissimilarity matrix from the selected @Pattern using the feature weights contained within the selected @FeatureWeights object. Dissimilarities are computed using the @@Euclidean distance@.")
ENTRY (U"See also:")
LIST_ITEM (U"@@Multidimensional scaling@")
LIST_ITEM (U"@@kNN classifiers 1.1.1. Feature weighting@")
LIST_ITEM (U"@@kNN classifiers@")
