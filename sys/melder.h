...
int Melder_errorW (const wchar_t *format, ...);   /* "Queue error" */
int Melder_errorW9 (const wchar_t *s1, const wchar_t *s2, const wchar_t *s3, const wchar_t *s4, const wchar_t *s5,
...
wchar_t * Melder_wstrdup (const wchar_t *string);
wchar_t * Melder_wstrdecompose (const wchar_t *string);
wchar_t * Melder_wstrprecompose (const wchar_t *string);
wchar_t * Melder_wstrExpandBackslashSequences (const wchar_t *string);
wchar_t * Melder_wstrReduceBackslashSequences (const wchar_t *string);
void Melder_wstrReduceBackslashSequences_inline (const wchar_t *string);
int Melder_isValidUtf8 (const char *string);
wchar_t * Melder_asciiToWstr (const char *string);
wchar_t * Melder_utf8ToWstr (const char *string);
wchar_t * Melder_isolatin1ToWstr (const char *string);
wchar_t * Melder_macromanToWstr (const char *string);
char * Melder_wstrToAscii (const wchar_t *string);
char * Melder_wstrToUtf8 (const wchar_t *string);
char * Melder_wstrToIsolatin1 (const wchar_t *string);
char * Melder_wstrToMacroman (const wchar_t *string);
