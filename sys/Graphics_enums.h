...
enums_begin (kGraphics_resolution, 0)
	...
	enums_add (kGraphics_resolution, 11, DPI_690, U"690 dpi")
	enums_add (kGraphics_resolution, 12, DPI_720, U"720 dpi")
	enums_add (kGraphics_resolution, 13, DPI_900, U"900 dpi")
	enums_add (kGraphics_resolution, 14, DPI_1200, U"1200 dpi")
enums_end (kGraphics_resolution, 14, DPI_100)
