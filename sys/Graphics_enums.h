/* Graphics_enums.h
 *
 * Copyright (C) 1992-2007,2013-2018 Paul Boersma
 *
...
enums_begin (kGraphics_resolution, 0)
	...
	enums_add (kGraphics_resolution, 3, DPI_180, U"180 dpi")
	enums_add (kGraphics_resolution, 4, DPI_200, U"200 dpi")
	enums_add (kGraphics_resolution, 5, DPI_300, U"300 dpi")
	enums_add (kGraphics_resolution, 6, DPI_360, U"360 dpi")
	enums_add (kGraphics_resolution, 7, DPI_600, U"600 dpi")
	enums_add (kGraphics_resolution, 8, DPI_720, U"720 dpi")
	enums_add (kGraphics_resolution, 9, DPI_900, U"900 dpi")
	enums_add (kGraphics_resolution, 10, DPI_1200, U"1200 dpi")
enums_end (kGraphics_resolution, 10, DPI_100)
