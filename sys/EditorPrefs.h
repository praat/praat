...
#define EditorClassPrefs_addAny(Type,DefaultType,name) \
	private: \
...
#define EditorInstancePrefs_addAny(Type,DefaultType,name) \
	private: \
		static DefaultType _classDefault_##name; \
		virtual DefaultType _v_default_##name () { return our _classDefault_##name; } \
		static Type _classPref_##name; \
...
#define EditorClassPrefs_addInt(Klas,name,version,default)              EditorClassPrefs_addAny         (int, conststring32, name)
#define EditorClassPrefs_overrideInt(Klas,name,version,default)         EditorClassPrefs_overrideAny    (int, conststring32, name)
#define EditorInstancePrefs_addInt(Klas,name,version,default)           EditorInstancePrefs_addAny      (int, conststring32, name)
#define EditorInstancePrefs_overrideInt(Klas,name,version,default)      EditorInstancePrefs_overrideAny (int, conststring32, name)

#define EditorClassPrefs_addInteger(Klas,name,version,default)          EditorClassPrefs_addAny         (integer, conststring32, name)
#define EditorClassPrefs_overrideInteger(Klas,name,version,default)     EditorClassPrefs_overrideAny    (integer, conststring32, name)
#define EditorInstancePrefs_addInteger(Klas,name,version,default)       EditorInstancePrefs_addAny      (integer, conststring32, name)
#define EditorInstancePrefs_overrideInteger(Klas,name,version,default)  EditorInstancePrefs_overrideAny (integer, conststring32, name)

#define EditorClassPrefs_addDouble(Klas,name,version,default)           EditorClassPrefs_addAny         (double, conststring32, name)
#define EditorClassPrefs_overrideDouble(Klas,name,version,default)      EditorClassPrefs_overrideAny    (double, conststring32, name)
#define EditorInstancePrefs_addDouble(Klas,name,version,default)        EditorInstancePrefs_addAny      (double, conststring32, name)
#define EditorInstancePrefs_overrideDouble(Klas,name,version,default)   EditorInstancePrefs_overrideAny (double, conststring32, name)

#define EditorClassPrefs_addBool(Klas,name,version,default)             EditorClassPrefs_addAny         (bool, bool, name)
#define EditorClassPrefs_overrideBool(Klas,name,version,default)        EditorClassPrefs_overrideAny    (bool, bool, name)
