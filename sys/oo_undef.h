...
#undef oo_COLLECTION
#undef oo_TRANSIENT_FILE
#undef oo_TRANSIENT_FOLDER
#undef oo_UNSAFE_BORROWED_TRANSIENT_CONST_OBJECT_REFERENCE
#undef oo_UNSAFE_BORROWED_TRANSIENT_MUTABLE_OBJECT_REFERENCE
