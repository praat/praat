...
#define INTRO(text)  { kManPage_type::INTRO, text, 0.0, 0.0, nullptr, autoGraphics() },
#define ENTRY(text)  { kManPage_type::ENTRY, text, 0.0, 0.0, nullptr, autoGraphics() },
#define NORMAL(text)  { kManPage_type::NORMAL, text, 0.0, 0.0, nullptr, autoGraphics() },
#define LIST_ITEM(text)  { kManPage_type::LIST_ITEM, text, 0.0, 0.0, nullptr, autoGraphics() },
#define LIST_ITEM1(text)  { kManPage_type::LIST_ITEM1, text, 0.0, 0.0, nullptr, autoGraphics() },
#define LIST_ITEM2(text)  { kManPage_type::LIST_ITEM2, text, 0.0, 0.0, nullptr, autoGraphics() },
#define LIST_ITEM3(text)  { kManPage_type::LIST_ITEM3, text, 0.0, 0.0, nullptr, autoGraphics() },
#define TERM(text)  { kManPage_type::TERM, text, 0.0, 0.0, nullptr, autoGraphics() },
#define TERM1(text)  { kManPage_type::TERM1, text, 0.0, 0.0, nullptr, autoGraphics() },
#define TERM2(text)  { kManPage_type::TERM2, text, 0.0, 0.0, nullptr, autoGraphics() },
#define TERM3(text)  { kManPage_type::TERM3, text, 0.0, 0.0, nullptr, autoGraphics() },
#define DEFINITION(text)  { kManPage_type::DEFINITION, text, 0.0, 0.0, nullptr, autoGraphics() },
#define DEFINITION1(text)  { kManPage_type::DEFINITION1, text, 0.0, 0.0, nullptr, autoGraphics() },
#define DEFINITION2(text)  { kManPage_type::DEFINITION2, text, 0.0, 0.0, nullptr, autoGraphics() },
#define DEFINITION3(text)  { kManPage_type::DEFINITION3, text, 0.0, 0.0, nullptr, autoGraphics() },
#define CODE(text)  { kManPage_type::CODE, text, 0.0, 0.0, nullptr, autoGraphics() },
#define CODE1(text)  { kManPage_type::CODE1, text, 0.0, 0.0, nullptr, autoGraphics() },
#define CODE2(text)  { kManPage_type::CODE2, text, 0.0, 0.0, nullptr, autoGraphics() },
#define CODE3(text)  { kManPage_type::CODE3, text, 0.0, 0.0, nullptr, autoGraphics() },
#define CODE4(text)  { kManPage_type::CODE4, text, 0.0, 0.0, nullptr, autoGraphics() },
#define CODE5(text)  { kManPage_type::CODE5, text, 0.0, 0.0, nullptr, autoGraphics() },
#define PROTOTYPE(text)  { kManPage_type::PROTOTYPE, text, 0.0, 0.0, nullptr, autoGraphics() },
#define EQUATION(text)  { kManPage_type::EQUATION, text, 0.0, 0.0, nullptr, autoGraphics() },
#define PICTURE(width,height,draw)  { kManPage_type::PICTURE, nullptr, width, height, draw, autoGraphics() },
#define SCRIPT(width,height,text)  { kManPage_type::SCRIPT, text, width, height, nullptr, autoGraphics() },
