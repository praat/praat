...
#define TERM1(text)  { kManPage_type::TERM1, text, 0.0, 0.0, nullptr },
#define TERM2(text)  { kManPage_type::TERM2, text, 0.0, 0.0, nullptr },
#define TERM3(text)  { kManPage_type::TERM3, text, 0.0, 0.0, nullptr },
