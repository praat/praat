...
Prefs_begin (SoundAnalysisArea)
	...
	InstancePrefs_addDouble  (SoundAnalysisArea, pitch_voicingThreshold,          1, U"0.45")
	...
	InstancePrefs_addBool    (SoundAnalysisArea, log2_toLogFile,                  1, true)
		...
		InstancePrefs_addString (SoundAnalysisArea, log1_fileName,               1, U"~/Desktop/Pitch Log")
		InstancePrefs_addString (SoundAnalysisArea, log2_fileName,               1, U"~/Desktop/Formant Log")
		InstancePrefs_addString (SoundAnalysisArea, logScript3,                  1, U"~/Desktop/Log script 3")
		InstancePrefs_addString (SoundAnalysisArea, logScript4,                  1, U"~/Desktop/Log script 4")
	#elif defined (WIN32)
		InstancePrefs_addString (SoundAnalysisArea, log1_fileName,               1, U"C:\\WINDOWS\\DESKTOP\\Pitch Log.txt")
		InstancePrefs_addString (SoundAnalysisArea, log2_fileName,               1, U"C:\\WINDOWS\\DESKTOP\\Formant Log.txt")
		InstancePrefs_addString (SoundAnalysisArea, logScript3,                  1, U"C:\\WINDOWS\\DESKTOP\\Log script 3.praat")
		InstancePrefs_addString (SoundAnalysisArea, logScript4,                  1, U"C:\\WINDOWS\\DESKTOP\\Log script 4.praat")
	#else
		InstancePrefs_addString (SoundAnalysisArea, log1_fileName,               1, U"~/pitch_log")
		InstancePrefs_addString (SoundAnalysisArea, log2_fileName,               1, U"~/formant_log")
		InstancePrefs_addString (SoundAnalysisArea, logScript3,                  1, U"~/log_script3")
		InstancePrefs_addString (SoundAnalysisArea, logScript4,                  1, U"~/log_script4")
	#endif
