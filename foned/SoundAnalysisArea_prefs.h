...
Prefs_begin (SoundAnalysisArea)
	...
	InstancePrefs_addDouble  (SoundAnalysisArea, pitch_filteredAcCc_lowPassCutoffFrequency,    1, U"300.0")
	...
	InstancePrefs_addDouble  (SoundAnalysisArea, pitch_filteredAcCc_silenceThreshold,          1, U"0.03")
	InstancePrefs_addDouble  (SoundAnalysisArea, pitch_filteredAcCc_voicingThreshold,          1, U"0.45")
