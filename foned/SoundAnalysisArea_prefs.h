...
Prefs_begin (SoundAnalysisArea)
	...
	#elif defined (WIN32)
		InstancePrefs_addString (SoundAnalysisArea, log1_fileName,               1, U"C:\\WINDOWS\\DESKTOP\\pitchLog.txt")
		InstancePrefs_addString (SoundAnalysisArea, log2_fileName,               1, U"C:\\WINDOWS\\DESKTOP\\formantLog.txt")
		InstancePrefs_addString (SoundAnalysisArea, logScript3,                  1, U"C:\\WINDOWS\\DESKTOP\\log3.praat")
		InstancePrefs_addString (SoundAnalysisArea, logScript4,                  1, U"C:\\WINDOWS\\DESKTOP\\log4.praat")
	#else
		InstancePrefs_addString (SoundAnalysisArea, log1_fileName,               1, U"~/pitchLog.txt")
		InstancePrefs_addString (SoundAnalysisArea, log2_fileName,               1, U"~/formantLog.txt")
		InstancePrefs_addString (SoundAnalysisArea, logScript3,                  1, U"~/log3.praat")
		InstancePrefs_addString (SoundAnalysisArea, logScript4,                  1, U"~/log4.praat")
	#endif
